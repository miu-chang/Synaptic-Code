 ...
 */
function createSynapticToolHandler(server, toolName, description, inputSchema) {
    return {
        definition: {
            type: 'function',
            function: {
        ...
        async execute(args) {
            const result = await client.execute(server, toolName, args);
            if (result.success) {
 ...
 */
export const blenderExecuteTool = {
    definition: {
        type: 'function',
        function: {
 ...
 */
export const blenderListToolsTool = {
    definition: {
        type: 'function',
        function: {
 ...
 */
export const unityListToolsTool = {
    definition: {
        type: 'function',
        function: {
 ...
 */
export const synapticHistoryTool = {
    definition: {
        type: 'function',
        function: {
...
export const synapticLogsTool = {
    ...
    async execute(args) {
        const { server, logType = 'error', limit = 10 } = args;
 ...
 */
export function getSynapticTools() {
    const tools = [];
 ...
 */
export function hasSynapticConnection() {
