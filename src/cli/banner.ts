...
export function printBanner(style: 'default' | 'simple' | 'block' | 'minimal' | 'gradient' | 'cool' = 'default'): void {
  switch (style) {
    case 'simple':
...
export function printStartupInfo(provider: string, model: string, toolCount: number): void {
